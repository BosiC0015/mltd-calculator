  ...
  return (
    <li className="menu-item" onClick={onClick}>
      <div className="item-link">
        <div className="arrow">
          <svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(45)" stroke="#333333" stroke-width="0.00024000000000000003">
