...
export default function MilliColle() {
  return (
    <div>
      ...
      <CountdownContainer endTime="2025-12-14T20:59:59.000+09:00" />
      <div className="event-essentials">
        {/* <p>🔸SR 1: Miki</p> */}
        {/* <p>🔸SR 2: Rio</p> */}
        {/* <p>🔹R: Minako</p> */}
      </div>
      <img className="banner" src="https://pbs.twimg.com/media/G7Slgz9agAADY6O?format=jpg&name=large" alt="event" />
    </div>
  );
};